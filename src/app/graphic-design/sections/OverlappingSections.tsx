      ...
      <section className="overlapping-cards">
        <div className={`flex card1  custom-card ${windowWidth <= 768 ? "" : ""}`} >
          <div className="graphic-page-sec2-content text-black">
            ...
            <p className="graphic-page-sec2-content-para">During COVID, ACM required a revamp of their brand, marketing and creative to build trust and reputation amid healthcare skepticism. With no internal design team, ACM worked with ACM to develop and implement a new brand, design a new website and all marketing marketials to help scale their business.</p>
            ...
            <div className="graphic-page-sec2-graphic-card">
              <Image className="graphic-page-sec2-gif" src="https://cdn.sanity.io/images/k0dlbavy/production/f88e1b003c40f368954177828408674bf35ada35-2400x1600.jpg?auto=format&fit=max&q=100&w=1800" alt="gif" width={500} height={500} />
            </div>
