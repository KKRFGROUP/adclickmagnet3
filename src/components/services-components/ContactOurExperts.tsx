...
function ContactOurExperts() {
  return (
    <div className='p-[80px] h-[50vh] mb-9 contact-our-expert-container'>
        <div className="flex contact-our-expert-card">
            ...
            <Image className='w-[30%] rounded-2xl contact-our-expert-card-img' src="https://images.unsplash.com/photo-1528747045269-390fe33c19f2?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="contact" height={400} width={400} />
        </div>
    </div>
  )
}
