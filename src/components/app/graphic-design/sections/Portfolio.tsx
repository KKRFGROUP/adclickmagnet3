    ...
    return (
      <section className="portfolio-sec-container">
        ...
        <div className='flex items-end gap-9 text-center portfolio-sec-card-container'>
          <figure>
            <Image className='portfolio-sec-card-img' width={500} height={500} src="https://adclickmagnetimage.blr1.cdn.digitaloceanspaces.com/Graphicdesign/Selected-Projects-1%20-%20Copy.webp" alt="portfolio img" />
          </figure>
        ...
        <div className='portfolio-sec-card-container flex justify-end text-center items-end gap-9 mt-9 mb-9'>
          ...
          <figure>
            <Image className='portfolio-sec-card-img' width={500} height={500} src="https://adclickmagnetimage.blr1.cdn.digitaloceanspaces.com/Graphicdesign/02.webp" alt="portfolio img" />
          </figure>
        </div>

        <div className='portfolio-sec-card-container text-center flex items-end gap-9 mt-9'>
          <figure>
            <Image className='portfolio-sec-card-img' width={500} height={500} src="https://adclickmagnetimage.blr1.cdn.digitaloceanspaces.com/Graphicdesign/Selected-projects-3.webp" alt="portfolio img" />
          </figure>
          <div className="flex justify-center items-center">
